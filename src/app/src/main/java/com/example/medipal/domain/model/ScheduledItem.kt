...
sealed class ScheduledItem(open val scheduleTime: Long) {
    ...
    data class AppointmentItem(val data: Appointment) : ScheduledItem(data.scheduleTime)
    data class ReminderItem(val data: Reminder) : ScheduledItem(data.scheduleTime)
}